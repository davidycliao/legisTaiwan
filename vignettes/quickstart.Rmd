...
<div style="text-align: justify">
Contributions in the form of comments, code suggestions, and tutorial examples are very welcome. Please note that the `LeigsTaiwan` is released with the [Contributor Code of Conduct](https://github.com/davidycliao/legisTaiwan/blob/master/inst/CONDUCT.md). By contributing to this project, you agree to abide by its terms.
