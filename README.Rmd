...
# legisTaiwan: <p style="font-size: 30px">Accessing the Real-time Archives of Taiwan Legislative Data.</p>  <img src="man/figures/logo.png" align="right" width="140"/>
<!-- badges: start -->
...
`legisTaiwan`  is an R package for downloading the real-time archives of Taiwan legislative data. The package is part of Yen-Chieh Liao's doctoral dissertation project [`Electoral Reform, Distributive Politics, and Parties in the Taiwanese Congress
