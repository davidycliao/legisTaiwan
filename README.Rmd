...
`legisTaiwan` is an R package for downloading the real-time archives of Taiwan legislative data in R via [Taiwan Legislative Yuan API](https://data.ly.gov.tw/index.action). 
