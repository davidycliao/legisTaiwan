## Real-time and Archives of Taiwan Legislative Data in R ![legisTaiwan logo](reference/figures/logo.png)
...
上或[我們](https://davidycliao.github.io)聯繫。
...
- The Legislative Yuan API has transitioned from `https://ly.govapi.tw`
  ...
  functions](https://davidycliao.github.io/legisTaiwan/) attached with
  API V2.
